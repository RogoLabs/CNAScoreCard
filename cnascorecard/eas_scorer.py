...
def calculate_eas(cve_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    total_eas_score = (
        foundational_score * 0.30 +  # 30 points = 30% of total
        root_cause_score * 0.20 +    # 20 points = 20% of total  
        severity_score * 0.25 +      # 25 points = 25% of total
        actionable_score * 0.20 +    # 20 points = 20% of total
        format_score * 0.05          # 5 points = 5% of total
    )
